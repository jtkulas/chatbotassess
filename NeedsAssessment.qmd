...
abstract: "We create a chatbot that asks traditional needs assessment questions and pinpoints what psychological constructs need to be improved in the organization. Takes the pulse of the organization. We could train it with needs assessment case studies, and similar data, and then use the cross-validity predictive performance metrics as analogous to a validity coefficient."
